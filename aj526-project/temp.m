    ...
    par.simName = 'MGS_16x16_16QAM'; % simulation name (used for saving results)
    ...
    par.SNRdB_list = 10:4:26; % list of SNR [dB] values to be simulated
    ...
    par.detector = {'MGS'}; % define detector(s) to be simulated 
    ...
    par.c1 = 80; % choose c1 based on qam size(higher value for higher QAM)
